...
# Le chemin du driver
gecko_driver_path = "../Users/DELL/Downloads/geckodriver-v0.32.2-win32/geckodriver.exe"
## Ouvre un navigateur
driver = webdriver.Firefox(executable_path=gecko_driver_path)

## Charge la page à l'URL
...
ListIdGroup=rechercheGoogle("Faya",40)  
nbpage=1
...
if __name__ == '__main__':
        ...
        df.to_csv("../data/Faya.csv") # pour faya.csv à la suite
